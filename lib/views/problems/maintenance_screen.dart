      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'We apologize that we are not serving you right now due to maintenance of the app, in order to provide you with a better experience',
              textAlign: TextAlign.center,
