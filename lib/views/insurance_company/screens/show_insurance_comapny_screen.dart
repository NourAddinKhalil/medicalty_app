...
class ShowInsuranceComapnyScreen extends GetView {
  const ShowInsuranceComapnyScreen({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              const CustomShowField(
                title: 'name of the insurance compan',
              ),
              const VerticalSizedBox(15),
              const CustomShowField(
                title: 'Description of the insurance company',
                minHeight: 120,
