...
import '../widgets/all_popular_doctors_card_widget.dart';

class AllPopularDoctorsScreen extends StatelessWidget {
  const AllPopularDoctorsScreen({super.key});
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const AllPopularDoctorsCardWidget(),
                  ],
                ),
              ),
            )
