...
import 'package:medicalty/controllers/screen_controllers/center_screen_controller.dart';
...
class AddNewCenterScreen extends GetView<CenterScreenController> {
    ...
    return GestureDetector(
      ...
      child: AppBackground(
        child: Scaffold(
          ...
          body: SafeArea(
            child: GetBuilder<CenterScreenController>(
                init: CenterScreenController(),
                builder: (controller) {
                  return CustomForm(
                    ...
                    children: [
                      ...
                      CustomTextFormField(
                        label: 'Full name',
                        controller: controller.centerNameTxtField,
